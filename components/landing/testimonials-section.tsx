...
const testimonials = [
  {
    quote: "Nous touchons 40 000 clients via WhatsApp et Email depuis un seul écran. Kineet a remplacé trois outils pour nous.",
    author: "Sarah Chen",
    role: "Responsable croissance",
    company: "Meridian Retail",
    metric: { value: "40K", label: "Contacts touchés" },
  },
  {
    quote: "L'import Excel fonctionne parfaitement. Nous chargeons notre liste, corrigeons les lignes invalides et envoyons en quelques minutes.",
    author: "Marcus Webb",
    role: "Responsable marketing",
    company: "Flux Events",
    metric: { value: "10x", label: "Campagnes plus rapides" },
  },
  {
    quote: "La personnalisation avec variables a transformé nos taux d'ouverture. Chaque message semble unique.",
    author: "Elena Rodriguez",
    role: "Responsable CRM",
    company: "Beacon Studio",
    metric: { value: "98%", label: "Taux de livraison" },
  },
  {
    quote: "Changer de canal est simple. SMS pour les rappels, Email pour les newsletters, WhatsApp pour le support.",
    author: "James Liu",
    role: "Directeur des opérations",
    company: "Prism Logistics",
    metric: { value: "3", label: "Canaux, une app" },
  },
];
